...
def _mask_aadhaar(aadhaar: Any) -> str:
    val = _str_value(aadhaar)
    if len(val) == 12:
...
FIELD_DEFINITIONS: list[FieldDefinition] = [
    ...
    FieldDefinition("iv", "Aadhaar number (after obtaining consent)", lambda e: _mask_aadhaar(e.aadhaar_number)),
